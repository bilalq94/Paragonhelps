                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="."><img src="images/logo.svg" alt="Paragon"></a>
                        </div>
                                    ...
                                    <div class="dropdown-menu custom-dropdown-menu">
                                        <div class="dropdown-items-holder">
                                            ...
                                            <div class="items">
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-6">
                                                        <a href="#" class="link">Paragon Features</a>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6">
    ...
    <div class="container">
            ...
            <div class="col-xs-6 col-sm-2 col-md-2 col-lg-2">
                <div class="footer-menu">
                    ...
                    <ul>
                        ...
                        <li><a href="wordpresshosting">Wordpress Hosting</a></li>
                        <li><a href="cloudhosting">Cloud Hosting</a></li>
                        <li><a href="vpshosting">VPS Hosting</a></li>
            ...
            <div class="col-xs-6 col-sm-2 col-md-2 col-lg-2">
                <div class="footer-menu">
                    ...
                    <ul>
                        ...
                        <li><a href="domains">Transfer Domains</a></li>
                        <li><a href="domains">Manage Domains</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="sub-footer">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="copyright">© Copyright 2018 Paragon Hosting LLC, All Rights Reserved</div>
                </div>
            </div>
        </div>
    </div>
